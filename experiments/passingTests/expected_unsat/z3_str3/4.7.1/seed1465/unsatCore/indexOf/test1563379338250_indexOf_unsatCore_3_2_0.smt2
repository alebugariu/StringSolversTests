...
(assert (! 
 ...
 (let (($x381 (= ?x147 1)))
 (let ((?x379 (str.at s 0)))
 (let (($x380 (= ?x379 s_fresh)))
 (and $x380 $x381))))) :named a1))
(assert (! 
 (let (($x205 (= result (- 1))))
 (let (($x206 (= $x205 true)))
 (let ((?x124 (str.++ s1 s2)))
 ...
 (let (($x165 (= t "")))
 (let (($x173 (= $x165 false)))
 (let (($x1348 (ite (and $x173 $x1341) (and (and (= (str.++ ?x124 (str.++ t s4)) s_fresh) $x199) $x202) $x206)))
 (and (=> (and (= $x165 true) $x1341) (= (= result offset) true)) $x1348))))))))))))))))) :named a2))
(assert (! 
