...
(assert (! 
 (let (($x21 (= result "")))
 (let (($x1252 (= $x21 tmp_bool4_fresh)))
 (let (($x156 (= s2 result)))
 (let (($x1249 (= $x156 tmp_bool4_fresh)))
 (let ((?x153 (str.len s2)))
 (let (($x154 (= ?x153 length)))
 (let ((?x128 (str.len s1)))
 (let (($x152 (= ?x128 offset)))
 (let (($x155 (and $x152 $x154)))
 (let (($x1250 (and $x155 $x1249)))
 (let ((?x124 (str.++ s1 s2)))
 (let ((?x126 (str.++ ?x124 s3)))
 (let (($x127 (= ?x126 s)))
 (let (($x1251 (and $x127 $x1250)))
 (let (($x150 (> length 0)))
 (let ((?x147 (str.len s)))
 ...
 (ite $x151 $x1251 $x1252))))))))))))))))))))) :named a1))
(assert (! 
 (let (($x650 (str.prefixof tmp_str3 tmp_str3)))
 (= $x650 tmp_bool4_fresh)) :named a2))
(assert (! 
