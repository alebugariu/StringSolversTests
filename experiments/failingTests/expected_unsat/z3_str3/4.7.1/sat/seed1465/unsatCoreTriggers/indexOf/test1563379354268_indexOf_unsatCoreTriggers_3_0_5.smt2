...
(assert (! 
 (let ((?x1315 (str.replace t tmp_str11 tmp_str12)))
 (let (($x1316 (= ?x1315 t_fresh)))
 (and $x1316 (= (str.indexof t tmp_str11 0) (- 1))))) :named a1))
(assert (! 
 (let (($x207 (= result (- 1))))
 (let (($x208 (= $x207 true)))
 (let ((?x124 (str.++ s1 s2)))
...
;actual status: sat
;(error "line 55 column 10: check annotation that says unsat")
