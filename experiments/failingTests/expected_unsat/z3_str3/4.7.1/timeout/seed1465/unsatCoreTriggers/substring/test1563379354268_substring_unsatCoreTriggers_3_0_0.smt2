...
(assert (! 
 ...
 (let (($x156 (= s2 result)))
 (let (($x157 (= $x156 true)))
 (let (($x1193 (and (and (= (str.len s1) offset_fresh) (= (str.len s2) length)) $x157)))
 (let ((?x124 (str.++ s1 s2)))
 (let ((?x126 (str.++ ?x124 s3)))
 (let (($x127 (= ?x126 s)))
 (let (($x150 (> length 0)))
 (let (($x1190 (and (and (>= offset_fresh 0) (< offset_fresh (str.len s))) $x150)))
 (ite $x1190 (and $x127 $x1193) $x22))))))))))) :named a1))
(assert (! 
