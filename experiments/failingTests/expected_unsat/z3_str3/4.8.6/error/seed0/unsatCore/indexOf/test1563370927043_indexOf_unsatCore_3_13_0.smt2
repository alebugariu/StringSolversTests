...
(assert (! 
 (and (= (str.indexof tmp_str8 tmp_str9 tmp_int10) tmp_int8_fresh) (or (< tmp_int10 0) (> tmp_int10 (str.len tmp_str8)))) :named a1))
(assert (! 
 (let ((?x124 (str.++ s1 s2)))
 ...
 (let (($x172 (=> $x169 $x171)))
 (and $x172 (ite $x174 $x203 (= (= result tmp_int8_fresh) true))))))))))))))))))))))))))) :named a2))
(assert (! 
