...
(assert (! 
 (= (str.contains tmp_str1 tmp_str1) tmp_bool1_fresh) :named a1))
(assert (! 
 (let ((?x124 (str.++ s1 s2)))
 ...
 (let (($x1536 (=> (and (= $x165 tmp_bool1_fresh) $x168) (= (= result offset) tmp_bool1_fresh))))
 (and $x1536 (ite $x174 $x203 (= (= result (- 1)) tmp_bool1_fresh))))))))))))))))))))))) :named a2))
(assert (! 
