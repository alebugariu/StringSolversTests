...
(assert (! 
 (let ((?x1143 (str.len tmp_str3)))
 (let ((?x1142 (str.len tmp_str1)))
 (let (($x1180 (= ?x1142 ?x1143)))
 (let (($x1275 (= $x1180 false)))
 (let (($x1140 (= tmp_str1 tmp_str3)))
 (let (($x1141 (= $x1140 tmp_bool1_fresh)))
 (and $x1141 $x1275))))))) :named a1))
(assert (! 
