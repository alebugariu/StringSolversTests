...
(assert (! 
 (and (= (str.indexof tmp_str4 tmp_str13 tmp_int15) tmp_int15_fresh) (or (< tmp_int15 0) (> tmp_int15 (str.len tmp_str4)))) :named a1))
(assert (! 
 ...
 (ite $x287 $x289 (= (= result tmp_int15_fresh) true)))))))) :named a2))
(assert (! 
