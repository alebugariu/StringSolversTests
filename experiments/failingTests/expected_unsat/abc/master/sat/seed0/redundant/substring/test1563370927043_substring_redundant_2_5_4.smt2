...
(assert  
 (and (= (str.replace s3 tmp_str5 tmp_str6) s3_fresh) (= (str.contains s3 tmp_str5) false)))
(assert  
...
;unsat core: a0 a1 
;actual status: sat
;I0815 22:48:06.461460 10255 main.cpp:292] report is_sat: SAT time: 119.882 ms
;I0815 22:48:06.461500 10255 main.cpp:356] done.
