...
(assert  
 (and (= (str.replace s2 tmp_str5 tmp_str6) s2_fresh) (= (str.contains s2 tmp_str5) false)))
(check-sat)
...
;unsat core: a0 a1 
;actual status: sat
;I0815 22:48:05.990577 10251 main.cpp:292] report is_sat: SAT time: 102.362 ms
;I0815 22:48:05.990607 10251 main.cpp:356] done.
