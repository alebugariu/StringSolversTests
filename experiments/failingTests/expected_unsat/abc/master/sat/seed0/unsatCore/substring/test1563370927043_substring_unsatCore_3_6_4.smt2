...
(assert  
 (and (= (str.replace result tmp_str5 tmp_str6) result_fresh) (= (str.contains result tmp_str5) false)))
(check-sat)
...
;unsat core: a0 a1 a2 
;actual status: sat
;I0815 22:48:23.931537 10328 main.cpp:292] report is_sat: SAT time: 811.831 ms
;I0815 22:48:23.931581 10328 main.cpp:356] done.
