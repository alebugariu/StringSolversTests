...
(assert (! 
 (= (str.to.int "7") tmp_int10_fresh) :named a1))
(assert (! 
 ...
 (let (($x66 (= $x65 true)))
 (let (($x70 (=> $x66 $x69)))
 (let (($x842 (and $x70 (and (=> (= (= integer tmp_int10_fresh) true) $x76) $x92))))
 (let (($x61 (= result "5")))
 (let (($x62 (= $x61 true)))
 (let (($x58 (= integer 5)))
 (let (($x59 (= $x58 true)))
 ...
 (let (($x25 (= $x24 true)))
 (let (($x29 (=> $x25 $x28)))
 (let (($x848 (and $x29 (and $x35 (and $x42 (and $x49 (and $x56 (and $x63 $x842))))))))
 (let (($x21 (= result "")))
 (let (($x22 (= $x21 true)))
 (let (($x19 (< integer 0)))
 (let (($x23 (=> $x19 $x22)))
 (and $x23 (and $x848 $x110))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))) :named a2))
(assert (! 
