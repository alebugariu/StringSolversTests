...
(declare-fun tmp_int5_fresh () Int)
(declare-fun integer () Int)
(declare-fun result () String)
(assert (! 
 (= (str.to.int "3") tmp_int5_fresh) :named a1))
(assert (! 
 ...
 (let (($x38 (= $x37 true)))
 (let (($x42 (=> $x38 $x41)))
 (let (($x719 (and $x42 (and (=> (= (= integer tmp_int5_fresh) true) $x48) $x96))))
 (let (($x33 (= result "1")))
 (let (($x34 (= $x33 true)))
 (let (($x30 (= integer 1)))
 (let (($x31 (= $x30 true)))
 ...
 (let (($x19 (< integer 0)))
 (let (($x23 (=> $x19 $x22)))
 (and $x23 (and (and $x29 (and $x35 $x719)) $x110)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))) :named a2))
(assert (! 
