...
(assert (! 
 ...
 (let (($x52 (= $x51 true)))
 (let (($x56 (=> $x52 $x55)))
 (let (($x775 (and $x56 (and (=> (= (= integer tmp_int10_fresh) true) $x62) $x94))))
 (let (($x47 (= result "3")))
 (let (($x48 (= $x47 true)))
 (let (($x44 (= integer 3)))
 (let (($x45 (= $x44 true)))
 ...
 (let (($x19 (< integer 0)))
 (let (($x23 (=> $x19 $x22)))
 (and $x23 (and (and $x29 (and $x35 (and $x42 (and $x49 $x775)))) $x110)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))) :named a1))
(assert (! 
 (= (str.to.int "5") tmp_int10_fresh) :named a2))
(assert (! 
