...
(assert (! 
 (let ((?x443 (str.len tmp_str28)))
 (let (($x576 (>= tmp_int29 ?x443)))
 (let (($x575 (< tmp_int29 0)))
 (let (($x577 (or $x575 $x576)))
 (and (= (str.substr tmp_str28 tmp_int29 tmp_int30) empty_fresh) (or $x577 (<= tmp_int30 0))))))) :named a1))
(assert (! 
