...
(assert (! 
 (and (= (int.to.str tmp_int6) tmp_str7_fresh) (= (= tmp_int6 3) true)) :named a1))
(assert (! 
 ...
 (let (($x38 (= $x37 true)))
 (let (($x42 (=> $x38 $x41)))
 (let (($x735 (and $x42 (and (=> $x45 (= (= result tmp_str7_fresh) true)) $x96))))
 (let (($x33 (= result "1")))
 (let (($x34 (= $x33 true)))
 (let (($x30 (= integer 1)))
 (let (($x31 (= $x30 true)))
 ...
 (let (($x19 (< integer 0)))
 (let (($x23 (=> $x19 $x22)))
 (and $x23 (and (and $x29 (and $x35 $x735)) $x110)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))) :named a2))
(assert (! 
