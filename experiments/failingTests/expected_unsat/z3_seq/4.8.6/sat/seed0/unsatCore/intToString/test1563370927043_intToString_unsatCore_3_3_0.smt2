...
(assert (! 
 (and (= (str.at tmp_str28 tmp_int29) empty_fresh) (or (< tmp_int29 0) (>= tmp_int29 (str.len tmp_str28)))) :named a1))
(assert (! 
 ...
 (and (=> (< integer 0) (= (= result empty_fresh) true)) $x111)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))) :named a2))
(assert (! 
...
;actual status: sat
;(error "line 88 column 10: check annotation that says unsat")
