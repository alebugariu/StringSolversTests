...
(assert (! 
 (and (= (int.to.str tmp_int7) tmp_str8_fresh) (= (= tmp_int7 4) true)) :named a1))
(assert (! 
 ...
 (let (($x45 (= $x44 true)))
 (let (($x49 (=> $x45 $x48)))
 (let (($x764 (and $x49 (and (=> $x52 (= (= result tmp_str8_fresh) true)) $x95))))
 (let (($x40 (= result "2")))
 (let (($x41 (= $x40 true)))
 (let (($x37 (= integer 2)))
 (let (($x38 (= $x37 true)))
 ...
 (let (($x19 (< integer 0)))
 (let (($x23 (=> $x19 $x22)))
 (and $x23 (and (and $x29 (and $x35 (and $x42 $x764))) $x110))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))) :named a2))
(assert (! 
