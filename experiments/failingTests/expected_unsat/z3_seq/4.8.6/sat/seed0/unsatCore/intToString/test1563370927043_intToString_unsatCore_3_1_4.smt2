...
(assert (! 
 (and (= (str.replace result tmp_str28 tmp_str29) result_fresh) (= (str.contains result tmp_str28) false)) :named a1))
(assert (! 
...
;actual status: sat
;(error "line 92 column 10: check annotation that says unsat")
