...
(assert (! 
 (and (= (int.to.str tmp_int5) tmp_str6_fresh) (= (= tmp_int5 2) true)) :named a1))
(assert (! 
 ...
 (let (($x31 (= $x30 true)))
 (let (($x35 (=> $x31 $x34)))
 (let (($x718 (and $x35 (and (=> $x38 (= (= result tmp_str6_fresh) true)) $x97))))
 (let (($x27 (= result "0")))
 (let (($x28 (= $x27 true)))
 (let (($x24 (= integer 0)))
 (let (($x25 (= $x24 true)))
 ...
 (let (($x19 (< integer 0)))
 (let (($x23 (=> $x19 $x22)))
 (and $x23 (and (and $x29 $x718) $x110))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))) :named a2))
(assert (! 
