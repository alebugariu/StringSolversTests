...
(declare-fun tmp_str29 () String)
(declare-fun integer () Int)
(assert (! 
 (let ((?x555 (str.replace result tmp_str28 tmp_str29)))
 (let (($x556 (= ?x555 result_fresh)))
 (and $x556 (= (str.indexof result tmp_str28 0) (- 1))))) :named a1))
(assert (! 
...
;actual status: sat
;(error "line 94 column 10: check annotation that says unsat")
