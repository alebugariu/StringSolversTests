...
(declare-fun tmp_int30 () Int)
(declare-fun tmp_str28 () String)
(declare-fun tmp_int29 () Int)
(assert (! 
 ...
 (let (($x19 (< integer 0)))
 (let (($x589 (=> $x19 $x588)))
 (and $x589 $x111)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))) :named a1))
(assert (! 
 (let ((?x451 (str.len tmp_str28)))
 (let (($x584 (>= tmp_int29 ?x451)))
 (let (($x583 (< tmp_int29 0)))
 (let (($x585 (or $x583 $x584)))
 (and (= (str.substr tmp_str28 tmp_int29 tmp_int30) empty_fresh) (or $x585 (<= tmp_int30 0))))))) :named a2))
(assert (! 
...
;actual status: sat
;(error "line 97 column 10: check annotation that says unsat")
