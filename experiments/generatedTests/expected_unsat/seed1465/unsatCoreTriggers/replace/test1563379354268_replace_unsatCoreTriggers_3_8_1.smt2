...
(assert (! 
 ...
 (let (($x1165 (>= index tmp_int1_fresh)))
 (let (($x1166 (ite $x1165 $x137 $x139)))
 (let ((?x1163 (str.indexof s t tmp_int1_fresh)))
 (let (($x1164 (= ?x1163 index)))
 (and $x1164 $x1166)))))))))))))))))))) :named a2))
(assert (! 
