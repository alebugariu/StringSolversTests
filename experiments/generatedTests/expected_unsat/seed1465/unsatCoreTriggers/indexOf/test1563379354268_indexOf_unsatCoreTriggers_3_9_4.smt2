...
(assert (! 
 (let ((?x1337 (str.len tmp_str11)))
 (let (($x1521 (>= tmp_int12 ?x1337)))
 (let (($x1520 (< tmp_int12 0)))
 (let (($x1522 (or $x1520 $x1521)))
 (and (= (str.substr tmp_str11 tmp_int12 tmp_int13) empty_fresh) (or $x1522 (<= tmp_int13 0))))))) :named a1))
(assert (! 
 (let (($x207 (= result (- 1))))
 (let (($x208 (= $x207 true)))
 (let ((?x124 (str.++ s1 s2)))
