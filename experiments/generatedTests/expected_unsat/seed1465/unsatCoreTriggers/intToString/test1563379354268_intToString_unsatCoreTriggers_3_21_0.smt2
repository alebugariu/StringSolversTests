...
(assert (! 
 (and (= (int.to.str tmp_int12) tmp_str13_fresh) (= (= tmp_int12 8) true)) :named a1))
(assert (! 
 ...
 (let (($x73 (= $x72 true)))
 (let (($x77 (=> $x73 $x76)))
 (let (($x899 (and $x77 (and (=> $x80 (= (= result tmp_str13_fresh) true)) $x91))))
 (let (($x68 (= result "6")))
 (let (($x69 (= $x68 true)))
 (let (($x65 (= integer 6)))
 (let (($x66 (= $x65 true)))
 ...
 (let (($x31 (= $x30 true)))
 (let (($x35 (=> $x31 $x34)))
 (let (($x905 (and $x35 (and $x42 (and $x49 (and $x56 (and $x63 (and $x70 $x899))))))))
 (let (($x27 (= result "0")))
 (let (($x28 (= $x27 true)))
 (let (($x24 (= integer 0)))
 (let (($x25 (= $x24 true)))
 ...
 (let (($x19 (< integer 0)))
 (let (($x23 (=> $x19 $x22)))
 (and $x23 (and (and $x29 $x905) $x110)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))) :named a2))
(assert (! 
