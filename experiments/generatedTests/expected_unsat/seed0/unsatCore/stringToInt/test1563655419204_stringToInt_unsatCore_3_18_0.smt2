...
(assert (! 
 (and (= (str.indexof tmp_str16 tmp_str17 tmp_int18) tmp_int16_fresh) (or (< tmp_int18 0) (> tmp_int18 (str.len tmp_str16)))) :named a1))
(assert (! 
 ...
 (ite $x283 $x285 (= (= result tmp_int16_fresh) true)))))))) :named a2))
(assert (! 
