...
(assert (! 
 ...
 (let (($x1537 (=> (and (= $x165 tmp_bool1_fresh) $x168) (= (= result offset) tmp_bool1_fresh))))
 (and $x1537 (ite $x174 $x205 (= (= result (- 1)) tmp_bool1_fresh))))))))))))))))))))))) :named a1))
(assert (! 
 (= (str.contains tmp_str11 tmp_str11) tmp_bool1_fresh) :named a2))
(assert (! 
